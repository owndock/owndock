...
for name in mongodb-root-username mongodb-root-password mongodb-app-password mongodb-keyfile owndock-bootstrap-token owndock-mongodb-uri owndock-mongodb-tools.yaml; do
...
printf 'uri: "mongodb://%s:%s@mongodb:27017/?replicaSet=rs0&authSource=owndock"\n' \
  "owndock-app" "$app_password" >"$directory/owndock-mongodb-tools.yaml"
