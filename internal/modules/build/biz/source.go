...
var (
	...
	ErrInvalidBuildConfiguration      = errors.New("build configuration is invalid")
	ErrAutomaticDeploymentDenied      = errors.New("automatic deployment is allowed only for development environments")
	ErrVersionConflict                = errors.New("build configuration version conflict")
	ErrRegistryMismatch               = errors.New("registry credential does not match image repository")
	ErrInvalidBuild                   = errors.New("build is invalid")
	ErrRevisionNotFound               = errors.New("source revision was not found")
	ErrRevisionMismatch               = errors.New("source revision does not match expected commit")
	ErrRevisionResolveUnavailable     = errors.New("source revision resolution is unavailable")
	ErrDuplicateIdempotency           = errors.New("build idempotency key already exists")
	ErrIdempotencyMismatch            = errors.New("build idempotency key was used with different intent")
	ErrInvalidBuildTrigger            = errors.New("build trigger is invalid")
	ErrInvalidBuildTriggerToken       = errors.New("build trigger token is invalid")
	ErrBuildTriggerRevoked            = errors.New("build trigger is revoked")
	ErrBuildTriggerRateLimited        = errors.New("build trigger rate limit exceeded")
	ErrWebhookRateLimited             = errors.New("webhook rate limit exceeded")
	ErrInvalidBuildHook               = errors.New("build hook is invalid")
	ErrInvalidWebhook                 = errors.New("webhook request is invalid")
	...
	ErrDuplicateWebhookDelivery       = errors.New("webhook delivery already exists")
	ErrInvalidBuildTransition         = errors.New("build status transition is invalid")
	ErrInvalidBuildLease              = errors.New("build lease is invalid")
	ErrBuildNotClaimable              = errors.New("build is not claimable")
	ErrBuildLeaseExpired              = errors.New("build lease is expired")
	ErrInvalidBuildFailure            = errors.New("build failure category is invalid")
	ErrBuildRetryRequiresFailed       = errors.New("only a failed build can be retried")
	ErrInvalidArtifact                = errors.New("build artifact is invalid")
	ErrDuplicateArtifact              = errors.New("build artifact already exists")
	ErrArtifactReleaseUnavailable     = errors.New("artifact release creation is unavailable")
	ErrArtifactAlreadyReleased        = errors.New("artifact already has a release")
	ErrArtifactRegistryAuthentication = errors.New("artifact registry authentication failed")
	ErrArtifactRegistryUnavailable    = errors.New("artifact registry is unavailable")
	ErrArtifactRegistryIntegrity      = errors.New("artifact registry response failed integrity verification")
)
