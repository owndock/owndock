...
func TestRolePermissions(t *testing.T) {
	tests := []struct {
		...
		{RoleViewer, PermissionArtifactCreate, false},
		{RoleDeveloper, PermissionArtifactCreate, true},
		{RoleViewer, PermissionArtifactEvidenceRead, true},
		{RoleViewer, PermissionSignatureTrustPolicyRead, true},
		{RoleDeveloper, PermissionSignatureTrustPolicyWrite, false},
		{RoleMaintainer, PermissionSignatureTrustPolicyWrite, true},
		{RoleViewer, PermissionVulnerabilityWaiverRead, true},
		{RoleDeveloper, PermissionVulnerabilityWaiverWrite, false},
		{RoleMaintainer, PermissionVulnerabilityWaiverWrite, true},
		{RoleViewer, PermissionDeploymentPolicyRead, true},
		{RoleDeveloper, PermissionDeploymentPolicyWrite, false},
		{RoleMaintainer, PermissionDeploymentPolicyWrite, true},
		{RoleViewer, PermissionSignatureVerificationWrite, false},
		{RoleDeveloper, PermissionSignatureVerificationWrite, true},
