...
- 已接受、尚未实现：Git 自建 CA/代理兼容矩阵、Agent 自动安装、Template、多主机系统验收，以及证书轮换/Terminal 的真实远程与浏览器安全验收
