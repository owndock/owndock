...
- 已接受、待完成或待验收：其他 KMS 客户矩阵，以及 Evidence Worker 的生产出口系统验收；Git/Registry 品牌与客户网络兼容矩阵、首个受保护 Agent Tag 的公开发行证据、多主机升级/回滚系统验收，以及 enrollment/证书轮换/Terminal 的真实远程与浏览器安全验收
